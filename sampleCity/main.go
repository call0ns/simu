...
func (P *sampleCity) listParam(truckID string) *listParam {
	levlog.Trace("List:", truckID)
...
func (P *sampleCity) unload(truckID string, parcels []Parcel) bool {
...
func (P *sampleCity) addParcels(parcels []Parcel) {
...
func (P *sampleCity) collectParcel() bool {
...
func (P *sampleCity) sumCity(city string) int {
...
func (P *sampleCity) pickCity() string {
	P.storedParcelMux.Lock()
	defer P.storedParcelMux.Unlock()
	maxVal := 0
	maxcity := ""
...
func (P *sampleCity) loadParcels(truckID, city string) bool {
	index := 0
	sum := 0
...
func (P *sampleCity) handleArrive() {
...
func (P *sampleCity) truckGoto(truckID, city string) bool {
...
func (P *sampleCity) fetchParcels() {
	P.startSignal <- true
	close(P.startSignal)
